  ...
  try {
    ...
    for (const templateName of templates) {
      ...
      registryItems[templateName] = {
        ...
        files,
        meta: {
          component: `React.lazy(() => import("app/registry/${templateName}/app/page.tsx"))`,
        },
      };
    }
    ...
    const registryContent = dedent`
      ...
      export const index: RegistryIndex = ${JSON.stringify(
        registryItems,
        null,
        2
      )}
