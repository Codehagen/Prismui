...
summary: A button component with enhanced animations, loading states, and flexible icon positioning. Features smooth hover effects, customizable variants, and built-in loading spinners for better user experience.
author: codehagen
