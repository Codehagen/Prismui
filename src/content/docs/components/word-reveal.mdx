...
summary: A text animation component that reveals words with a staggered motion effect. Perfect for hero sections, headlines, and engaging content with customizable timing and smooth reveal animations.
author: codehagen
