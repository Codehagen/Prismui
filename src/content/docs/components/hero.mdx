...
summary: A modern, animated hero section component with support for pills, content, and preview sections. Perfect for landing pages with gradient backgrounds, call-to-action buttons, and responsive design.
author: codehagen
