...
summary: Learn how to install and set up PrismUI in your project. Step-by-step guide for integrating PrismUI components with shadcn/ui, including CLI setup and component installation.
author: codehagen
slug: installation
---
