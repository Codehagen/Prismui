...
export { ButtonGroup };`,
  ...
  },
  {
    ...
    description:
      "A beautiful expandable card component with smooth animations and rich content display.",
    ...
    meta: {
      ...
      images: [
        {
          url: "/components/expandable-card-preview.png",
          name: "Expandable Card Preview",
          size: 0,
        },
      ],
      env: [
        {
          name: "NEXT_PUBLIC_V0_TEMPLATES_AUTHOR",
          url: "https://v0.dev",
        },
      ],
    },
