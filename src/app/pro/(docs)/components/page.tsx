...
export const metadata = constructMetadata({
  title: "Components - PrismUI Pro",
  description: "Browse our premium collection of React components including buttons, cards, animations, and page sections. Copy and paste into your apps.",
  keywords: ["React components", "UI library", "PrismUI Pro", "Tailwind CSS components", "shadcn/ui", "component library"],
})
...
export default async function ComponentsPage() {
  // Require pro access to view components
