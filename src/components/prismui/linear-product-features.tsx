...
interface LinearProductFeaturesProps {
  className?: string;
}

export default function LinearProductFeatures({ className }: LinearProductFeaturesProps) {
  return (
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            From issue tracking to roadmap planning, Linear provides everything your team needs to build better products faster.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="text-center">
              <h3 className="text-2xl font-semibold mb-4">Lightning-fast issue tracking</h3>
              <p className="text-muted-foreground text-lg">
                Create, assign, and track issues with keyboard shortcuts and instant search. Built for speed.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-center">
              <h3 className="text-2xl font-semibold mb-4">Strategic roadmap planning</h3>
              <p className="text-muted-foreground text-lg">
                Plan initiatives, track progress, and align your team around a shared product vision.
              </p>
            </div>
          </motion.div>
        </div>
...
// Issue Tracking Interactive Demo
const IssueTrackingDemo = () => {
  const [selectedIssue, setSelectedIssue] = useState(0);
  
  const issues = [
    { id: "LIN-123", title: "Implement dark mode toggle", status: "in-progress", priority: "high", assignee: "Sarah" },
    { id: "LIN-124", title: "Fix mobile navigation bug", status: "pending", priority: "urgent", assignee: "Mike" },
    { id: "LIN-125", title: "Add keyboard shortcuts", status: "completed", priority: "medium", assignee: "Alex" },
  ];
